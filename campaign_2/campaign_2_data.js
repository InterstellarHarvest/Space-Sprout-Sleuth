...
// recognizes sprites_c2/* paths and returns these arrays directly.
//
...
const CAMPAIGN_2_DATA = {
  ...
  cases: [
    ...
    // single-reveal dialogue nodes, stub text throughout.
    {
      ...
      sprites: {
        scene: "sprites_c2/scene_vressk_centrifuge.png"
      },
      ...
      clues: [
        {
          ...
          speaker: "Vressk Botanist",
          sprites: {
            spritesheet:     "sprites_c2/vressk_botanist/spritesheet.png",
            spritesheetJson: "sprites_c2/vressk_botanist/spritesheet.json",
    ...
    // Home-species advantage: Telluvian (primary crew NPC).
    {
      ...
      sprites: {
        scene: "sprites_c2/scene_ares_garden.png"
      },
      ...
      // dome air space.
      sceneFx: { type: 'dust', mask: 'sprites_c2/scene_ares_garden_mask.png' },
      ...
      clues: [
        {
          ...
          speaker: "Researcher Miran-sel",
          sprites: {
            spritesheet:     "sprites_c2/miransel/spritesheet.png",
            spritesheetJson: "sprites_c2/miransel/spritesheet.json",
            pingPong:        true,
    ...
    // blue-green. Home-species advantage: Oolian.
    {
      ...
      sprites: {
        scene: "sprites_c2/scene_oolian_dome.png"
      },
      ...
      // the tank volumes.
      sceneFx: { type: 'bubbles', mask: 'sprites_c2/scene_oolian_dome_mask.png' },
      ...
      clues: [
        {
          ...
          speaker: "Aquaculturist Tei-sal",
          sprites: {
            spritesheet:     "sprites_c2/teisal/spritesheet.png",
            spritesheetJson: "sprites_c2/teisal/spritesheet.json",
    ...
    // symbiosis). Includes the genesis pod callback. Home-species: Zhel'ii.
    {
      ...
      sprites: {
        scene: "sprites_c2/scene_zhelii_grove.png"
      },
      ...
      clues: [
        {
          ...
          speaker: "Caretaker Vess-lor",
          sprites: {
            spritesheet:     "sprites_c2/vesslor/spritesheet.png",
            spritesheetJson: "sprites_c2/vesslor/spritesheet.json",
    ...
    // the existing SOLUTION_CHOICE screen state from Case 6b.
    {
      ...
      sprites: {
        scene: "sprites_c2/scene_concord_vault.png"
      },
      ...
      clues: [
        {
          ...
          speaker: "Vault Admin Kel-tor",
          sprites: {
            spritesheet:     "sprites_c2/keltor/spritesheet.png",
            spritesheetJson: "sprites_c2/keltor/spritesheet.json",
    ...
    // finale with solution choice and sceneAlt crossfade.
    {
      ...
      sprites: {
        scene: "sprites_c2/scene_firstgarden.png",
        sceneAlt: "sprites_c2/scene_firstgarden_healed.png"
      },
      actionLabels: {
      ...
      clues: [
        {
          ...
          speaker: "Dr. Nova",
          sprites: {
            spritesheet:     "sprites_c2/nova/spritesheet_unmasked.png",
            spritesheetJson: "sprites_c2/nova/spritesheet_unmasked.json",
        ...
        },
        {
          ...
          speaker: "Delegate Vorn-Shael",
          sprites: {
            spritesheet:     "sprites_c2/delegate_shael/spritesheet.png",
            spritesheetJson: "sprites_c2/delegate_shael/spritesheet.json"
          },
          text: "See dialogue tree.",
        ...
        },
        {
          ...
          speaker: "Delegate Kess",
          sprites: {
            spritesheet:     "sprites_c2/delegate_kess/spritesheet.png",
            spritesheetJson: "sprites_c2/delegate_kess/spritesheet.json"
          },
          text: "See dialogue tree.",
        ...
        },
        {
          ...
          speaker: "Delegate Ilreth-Mar",
          sprites: {
            spritesheet:     "sprites_c2/delegate_ilreth/spritesheet.png",
            spritesheetJson: "sprites_c2/delegate_ilreth/spritesheet.json"
          },
          text: "See dialogue tree.",
